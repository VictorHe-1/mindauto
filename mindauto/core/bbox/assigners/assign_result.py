...
from mindauto.core.utils import NiceRepr
...
class AssignResult(NiceRepr):
    ...
    def random(cls, **kwargs):
        ...
        Example:
            ...
            >>> print(self.info)
        """
        from mindauto.core.bbox import demodata
        ...
        if num_gts == 0:
            ...
            max_overlaps = ms.Tensor(rng.rand(num_preds))

            # Construct gt_inds for each predicted box
            is_assigned = ms.Tensor(rng.rand(num_preds) < p_assigned)
