...
from mindauto.core.bbox.transforms import bbox_mapping_back
...
class BBoxTestMixin(object):
    ...
    #     merged_factors = ops.cat(aug_factors, axis=0) if aug_factors else None
    #     det_bboxes, det_labels = multiclass_nms(  # TODO
    #         merged_bboxes,
    #         merged_scores,
    ...
    #         _det_bboxes[:, :4] *= ms.Tensor(img_metas[0][0]['scale_factor'], dtype=det_bboxes.dtype)
    #
    #     return [
    ...
    #     merged_proposals = [
    #         merge_aug_proposals(proposals, aug_img_meta, self.test_cfg) # TODO
    #         for proposals, aug_img_meta in zip(aug_proposals, aug_img_metas)
    #     ]
    #     return merged_proposals

    # if sys.version_info >= (3, 7): # TODO
    ...
    def merge_aug_bboxes(self, aug_bboxes, aug_scores, img_metas):
        ...
        bboxes = ops.cat(recovered_bboxes, axis=0)
        if aug_scores is None:
            return bboxes
        else:
            scores = ops.cat(aug_scores, axis=0)
