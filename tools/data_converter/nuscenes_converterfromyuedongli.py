...
from mindauto.data.nuscenes_dataset import NuScenesDataset
...
def export_2d_annotation(root_path, info_path, version, mono3d=True):
    ...
    nusc_infos = pickle.load(info_path)['infos']
    ...
    for info in tqdm(nusc_infos):
        for cam in camera_types:
            ...
            coco_infos = get_2d_boxes(
                ...
                mono3d=mono3d)
            (height, width, _) = cv2.imread(cam_info['data_path']).shape
    ...
    json.dump(coco_2d_dict, f'{json_prefix}.coco.json')
